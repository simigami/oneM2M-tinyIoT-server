#define NGX_CONFIGURE " --prefix=/usr/local/nginx --sbin-path=/usr/local/nginx/sbin/nginx --conf-path=/usr/local/nginx/conf/nginx.conf --pid-path=/usr/local/nginx/mmc/nginx.pid --lock-path=/usr/local/nginx/mmc/nginx.lock --error-log-path=/usr/local/nginx/mmc/error.log --http-log-path=/usr/local/nginx/mmc/access-log --with-zlib=../zlib-1.2.12 --with-pcre=../pcre-8.45 --with-openssl=../openssl-1.1.1l --with-http_ssl_module --with-debug --user=nginx --group=nginx"
