#define NGX_CONFIGURE " --prefix=/usr/local/nginx --sbin-path=/usr/local/nginx/sbin/nginx --conf-path=/usr/local/nginx/conf/nginx.conf --pid-path=/usr/local/nginx/mmc/nginx.pid --lock-path=/usr/local/nginx/mmc/nginx.lock --error-log-path=/usr/local/nginx/mmc/error.log --http-log-path=/usr/local/nginx/mmc/access-log --with-zlib=../zlib-1.2.12 --with-pcre=../pcre-8.45 --with-openssl=../openssl-1.1.1l --with-http_ssl_module --with-debug --with-http_gzip_static_module --with-http_geoip_module --with-http_realip_module --add-module=../lua-nginx-module-0.10.12 --add-module=../ngx_devel_kit-0.3.0 --with-stream --with-stream_ssl_module --user=nginx --group=nginx"
